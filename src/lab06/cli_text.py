...
def main():
    ...
    cat_parser.add_argument("--input", required=True, help="Caminho para o arquivo de texto")
    cat_parser.add_argument("-n", action="store_true", help="Numerar as linhas")

    # --- Comando: stats ---
    # Uso: stats --input <arquivo> [--top 3]
    stats_parser = subparsers.add_parser("stats", help="Analisar frequência de palavras")
    stats_parser.add_argument("--input", required=True, help="Caminho para o arquivo de texto")
